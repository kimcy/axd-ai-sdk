...
// [A] 토큰 본문을 직접 박아 쓰는 dev 용. 운영에서는 [B] 처럼 쿠키 이름만 넘기세요.
const GATEWAY_TOKEN = 'eyJhbGciOiJIUzM4NCJ9..PKbziu4P_d45zoH2dkBfQ0znEC4gmf4kXBAs5p2WmVYlMJikvqmJy1eac3nnfxZC'
// const GATEWAY_TOKEN_COOKIE = 'gateway_token' // [B] 용 — 쿠키 이름
  ...
  const transport = useMemo(
    () =>
      new DefaultChatTransport({
        ...
        // [A] 토큰 문자열을 직접 사용 (현재 활성, dev 용)
        headers: bearer(GATEWAY_TOKEN),
